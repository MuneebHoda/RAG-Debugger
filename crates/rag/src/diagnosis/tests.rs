use rag_debugger_core::{
    ByteRange, ChunkPreview, ChunkSplitReason, ChunkingStrategy, DiagnosisOutcome,
    DiagnosisRemediationArea, Document, DocumentId, DocumentProfile, EmbeddingModelInfo,
    EvidenceStrength, ExtractionQuality, ExtractiveAnswer, ExtractiveAnswerStatus, ProjectId,
    RetrievalCitation, RetrievalEmbeddingReadiness, RetrievalEmbeddingStatus, RetrievalMode,
    RetrievalQualityFlag, RetrievalQueryHit, RetrievalQueryRun, RetrievalQueryRunId,
