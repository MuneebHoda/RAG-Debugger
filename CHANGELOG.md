...
- Repository governance baseline with automated issue-policy validation, private security-reporting guidance, actionable bug and feature forms, explicit CODEOWNERS coverage, and an exact-commit pre-release publication and rollback guide.
