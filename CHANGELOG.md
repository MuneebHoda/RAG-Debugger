...
- Repository governance baseline with private security-reporting guidance, actionable bug and feature issue forms, explicit CODEOWNERS coverage, and a pre-release publication and rollback guide.
