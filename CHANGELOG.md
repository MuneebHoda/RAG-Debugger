...
- Private-alpha deployment ADR and environment contract covering the Cloudflare/Render trust boundary, isolated staging/production configuration, fail-closed hosted startup, immutable promotion, migrations, recovery, cost limits, and scoped implementation ownership for issues #103–#108.
